...
public class DecoratorsSettingsTabs extends SettingsPreferenceFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        DecoratorsAdapter DecoratorsAdapter = new DecoratorsAdapter(getFragmentManager());
        mViewPager.setAdapter(DecoratorsAdapter);
    ...
    class DecoratorsAdapter extends FragmentPagerAdapter {
