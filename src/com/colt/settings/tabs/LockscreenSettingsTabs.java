...
public class LockscreenSettingsTabs extends SettingsPreferenceFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        LockScreenAdapter LockScreenAdapter = new LockScreenAdapter(getFragmentManager());
        mViewPager.setAdapter(LockScreenAdapter);
    ...
    class LockScreenAdapter extends FragmentPagerAdapter {
